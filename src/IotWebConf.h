...
// -- HTML page fragments
const char IOTWEBCONF_HTML_HEAD[] PROGMEM         = "<!DOCTYPE html><html lang=\"de\"><head><meta charset=\"utf-8\"><meta  name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\">\n<title>{v}</title>\n";   //Update:HK charset=\"utf-8\", ergänzt
